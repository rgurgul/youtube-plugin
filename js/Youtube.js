...
Youtube.prototype.showMyVideos = function(data) 
{
	...
	for ( var i = 0; i < entries.length; i++) 
	{
		...
		//alert(entry[ "yt$statistics" ].viewCount);
	...
	if (entries.length > 0) 
	{
		...
		this.loadVideo(entries[this.idFirstVideo].media$group.media$content[0].url, true,
				entries[this.idFirstVideo].title.$t, entries[this.idFirstVideo].author[0].name.$t,
